...
const
  g_lang_default: Array [TStrings_Locale] of Array [1..3] of String = (
    ...
    ('MENU ENABLE RULEZ RANDOM',       'Enable random powerup respawn:',
                                       'Рандомный респаун поверапов:'),
    ('MENU RULEZ RESPAWN MULTIPLIER',  'Time multiplier for powerup respawn:',
                                       'Множитель времени для респауна поверапов:'),
    ...
    ('MENU INTER NOTICE TIME',         '%d sec till the next round',
                                       'Осталось %d сек до следующего раунда'),
    ...
    ('PLAYER KICK',                    '%s was kicked by admin.',
                                       '%s был отключён администратором.'),
    ...
    ('MESSAGE VOTE INPROGRESS',        'A vote is already in progress for "%s".',
                                       'Уже идёт голосование за команду "%s".'),
    ...
    ('MSG RULEZ RANDOM ON',            'Random respawn for powerups on',
                                       'Рандомный респаун для поверапов включён'),
    ('MSG RULEZ RANDOM OFF',           'Random respawn for powerups off',
                                       'Рандомный респаун для поверапов выключен'),
    ...
    ('MSG NO MAP FALLBACK',            'Map "%s" doesn''t exist in this WAD, looking for %s.',
                                       'Карта "%s" не найдена в этом WAD файле, ищу %s.'),
    ...
    ('MSG SPAWNINVUL',                 'Spawn invulnerability time: %d sec*',
                                       'Неуязвимость после респауна: %d сек*'),
    ('MSG WARMUP START',               '%d sec until round start.',
                                       '%d сек до начала раунда.'),
    ...
    ('MSG GM UNAVAIL',                 'This command is unavailable in the current game mode.',
                                       'Команда недоступна в текущем режиме игры.'),
    ('MSG SERVERONLY',                 'This command is only available to servers.',
                                       'Команда доступна только в режиме сервера.'),
    ('MSG NOT NETGAME',                'This command is unavailable during a net game.',
                                       'Команда недоступна во время сетевой игры.'),
